...
QuickImageViewは、C++17、Win32、Windows Imaging Component、CMakeで構築するWindows向け画像ビューアー・編集アプリです。本書の対象バージョンは2.1.0です。
...
- ヘルプ > バージョン情報で、Ver. 2.1.0、開発環境、制作者、公式作者ワッペンをダークモーダルカードに表示する。
